...
void Vdata_memory___024root__trace_chg_sub_0(Vdata_memory___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[0U])) {
        bufp->chgBit(oldp+0,(vlSelf->data_memory__DOT__addr));
        bufp->chgIData(oldp+1,(vlSelf->data_memory__DOT__unnamedblk1__DOT__i),32);
    }
    bufp->chgBit(oldp+2,(vlSelf->clk_i));
    bufp->chgBit(oldp+3,(vlSelf->we_i));
    bufp->chgBit(oldp+4,(vlSelf->byte_op_i));
    bufp->chgIData(oldp+5,(vlSelf->addr_i),32);
    bufp->chgIData(oldp+6,(vlSelf->wd_i),32);
    bufp->chgIData(oldp+7,(vlSelf->rd_o),32);
}
