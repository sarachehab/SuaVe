...
void Vmain_decoder___024root__trace_chg_sub_0(Vmain_decoder___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgCData(oldp+0,(vlSelf->op_i),7);
    bufp->chgBit(oldp+1,(vlSelf->branch_o));
    bufp->chgBit(oldp+2,(vlSelf->jump_o));
    bufp->chgCData(oldp+3,(vlSelf->result_src_o),2);
    bufp->chgBit(oldp+4,(vlSelf->mem_write_o));
    bufp->chgBit(oldp+5,(vlSelf->alu_src_o));
    bufp->chgCData(oldp+6,(vlSelf->imm_src_o),2);
    bufp->chgBit(oldp+7,(vlSelf->reg_write_o));
    bufp->chgCData(oldp+8,(vlSelf->alu_op_o),2);
}
