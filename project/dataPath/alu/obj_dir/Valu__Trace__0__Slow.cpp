...
VL_ATTR_COLD void Valu___024root__trace_init_sub__TOP__0(Valu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,"alu_control_i", false,-1, 3,0);
    tracep->declBit(c+4,"eq_o", false,-1);
    tracep->declBus(c+5,"alu_result_o", false,-1, 31,0);
...
VL_ATTR_COLD void Valu___024root__trace_full_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+3,(vlSelf->alu_control_i),4);
    bufp->fullBit(oldp+4,(vlSelf->eq_o));
    bufp->fullIData(oldp+5,(vlSelf->alu_result_o),32);
