...
VL_ATTR_COLD void Vcache___024root__trace_init_sub__TOP__0(Vcache___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+17,"mem_incoming_data_i", false,-1, 31,0);
    tracep->declBus(c+18,"mem_address_o", false,-1, 31,0);
    tracep->declBus(c+19,"mem_write_data_o", false,-1, 31,0);
    tracep->declBit(c+20,"mem_write_enable_o", false,-1);
    tracep->declBus(c+21,"age_0", false,-1, 1,0);
    tracep->declBit(c+22,"valid_o", false,-1);
    tracep->pushNamePrefix("cache ");
    tracep->declBus(c+25,"set_bits", false,-1, 31,0);
    tracep->declBus(c+26,"tag_bits", false,-1, 31,0);
    tracep->declBus(c+27,"width", false,-1, 31,0);
    tracep->declBit(c+11,"clk_i", false,-1);
    tracep->declBit(c+12,"write_enable_i", false,-1);
    tracep->declBus(c+13,"address_i", false,-1, 31,0);
    tracep->declBus(c+14,"write_data_i", false,-1, 31,0);
    ...
    tracep->declBus(c+21,"age_0", false,-1, 1,0);
    tracep->declBit(c+22,"valid_o", false,-1);
    tracep->declBus(c+23,"tag", false,-1, 25,0);
    tracep->declBus(c+24,"set", false,-1, 3,0);
...
VL_ATTR_COLD void Vcache___024root__trace_full_sub_0(Vcache___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+17,(vlSelf->mem_incoming_data_i),32);
    bufp->fullIData(oldp+18,(vlSelf->mem_address_o),32);
    bufp->fullIData(oldp+19,(vlSelf->mem_write_data_o),32);
    bufp->fullBit(oldp+20,(vlSelf->mem_write_enable_o));
    bufp->fullCData(oldp+21,(vlSelf->age_0),2);
    bufp->fullBit(oldp+22,(vlSelf->valid_o));
    bufp->fullIData(oldp+23,((vlSelf->address_i >> 6U)),26);
    bufp->fullCData(oldp+24,((0xfU & (vlSelf->address_i 
                                      >> 2U))),4);
    bufp->fullIData(oldp+25,(4U),32);
    bufp->fullIData(oldp+26,(0x1aU),32);
