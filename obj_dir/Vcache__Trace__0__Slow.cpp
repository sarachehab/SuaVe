...
VL_ATTR_COLD void Vcache___024root__trace_init_sub__TOP__0(Vcache___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+26,"byte_op_i", false,-1);
    tracep->declBus(c+27,"address_i", false,-1, 31,0);
    tracep->declBus(c+28,"write_data_i", false,-1, 31,0);
    tracep->declBus(c+29,"read_data_o", false,-1, 31,0);
    ...
    tracep->declBus(c+28,"write_data_i", false,-1, 31,0);
    tracep->declBus(c+29,"read_data_o", false,-1, 31,0);
    tracep->declBus(c+16,"mem_incoming_data", false,-1, 31,0);
    tracep->declBus(c+27,"mem_address", false,-1, 31,0);
    tracep->declBus(c+17,"mem_write_data", false,-1, 31,0);
    tracep->declBit(c+24,"mem_write_enable", false,-1);
    tracep->declBit(c+18,"mem_byte_op", false,-1);
    ...
    tracep->declBus(c+28,"write_data_i", false,-1, 31,0);
    tracep->declBus(c+29,"read_data_o", false,-1, 31,0);
    tracep->declBus(c+16,"mem_incoming_data_i", false,-1, 31,0);
    tracep->declBus(c+27,"mem_address_o", false,-1, 31,0);
    tracep->declBus(c+17,"mem_write_data_o", false,-1, 31,0);
    tracep->declBit(c+24,"mem_write_enable_o", false,-1);
    tracep->declBit(c+18,"mem_byte_op_o", false,-1);
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+3+i*1,"cache_data", true,(i+0), 31,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+7+i*1,"cache_tag", true,(i+0), 29,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBit(c+11+i*1,"valid", true,(i+0));
    }
    tracep->declBus(c+15,"counter", false,-1, 1,0);
    tracep->declBus(c+30,"tag", false,-1, 29,0);
    tracep->declBus(c+31,"byteoffset", false,-1, 1,0);
    ...
    tracep->declBit(c+23,"clk_i", false,-1);
    tracep->declBit(c+24,"we_i", false,-1);
    tracep->declBit(c+18,"byte_op_i", false,-1);
    tracep->declBus(c+27,"addr_i", false,-1, 31,0);
    tracep->declBus(c+17,"wd_i", false,-1, 31,0);
    tracep->declBus(c+16,"rd_o", false,-1, 31,0);
...
VL_ATTR_COLD void Vcache___024root__trace_full_sub_0(Vcache___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+3,(vlSelf->cache__DOT__line__DOT__cache_data[0]),32);
    bufp->fullIData(oldp+4,(vlSelf->cache__DOT__line__DOT__cache_data[1]),32);
    bufp->fullIData(oldp+5,(vlSelf->cache__DOT__line__DOT__cache_data[2]),32);
    bufp->fullIData(oldp+6,(vlSelf->cache__DOT__line__DOT__cache_data[3]),32);
    bufp->fullIData(oldp+7,(vlSelf->cache__DOT__line__DOT__cache_tag[0]),30);
    bufp->fullIData(oldp+8,(vlSelf->cache__DOT__line__DOT__cache_tag[1]),30);
    bufp->fullIData(oldp+9,(vlSelf->cache__DOT__line__DOT__cache_tag[2]),30);
    bufp->fullIData(oldp+10,(vlSelf->cache__DOT__line__DOT__cache_tag[3]),30);
    bufp->fullBit(oldp+11,(vlSelf->cache__DOT__line__DOT__valid[0]));
    bufp->fullBit(oldp+12,(vlSelf->cache__DOT__line__DOT__valid[1]));
    bufp->fullBit(oldp+13,(vlSelf->cache__DOT__line__DOT__valid[2]));
    bufp->fullBit(oldp+14,(vlSelf->cache__DOT__line__DOT__valid[3]));
    bufp->fullCData(oldp+15,(vlSelf->cache__DOT__line__DOT__counter),2);
    bufp->fullIData(oldp+16,(vlSelf->cache__DOT__mem_incoming_data),32);
    bufp->fullIData(oldp+17,(vlSelf->cache__DOT__mem_write_data),32);
    bufp->fullBit(oldp+18,(vlSelf->cache__DOT__mem_byte_op));
    ...
    bufp->fullIData(oldp+22,(vlSelf->cache__DOT__memory__DOT__addr),32);
    bufp->fullBit(oldp+23,(vlSelf->clk_i));
    bufp->fullBit(oldp+24,(vlSelf->write_enable_i));
    bufp->fullBit(oldp+25,(vlSelf->cache_enable_i));
    bufp->fullBit(oldp+26,(vlSelf->byte_op_i));
    bufp->fullIData(oldp+27,(vlSelf->address_i),32);
    bufp->fullIData(oldp+28,(vlSelf->write_data_i),32);
    bufp->fullIData(oldp+29,(vlSelf->read_data_o),32);
    bufp->fullIData(oldp+30,((vlSelf->address_i >> 2U)),30);
    bufp->fullCData(oldp+31,((3U & vlSelf->address_i)),2);
