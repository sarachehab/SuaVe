...
void Vcpu___024root__trace_chg_sub_0(Vcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        ...
        bufp->chgIData(oldp+63,(vlSelf->cpu__DOT__datapath__DOT__data_mem_rd),32);
        bufp->chgIData(oldp+64,(vlSelf->cpu__DOT__datapath__DOT____Vcellinp__datapath_alu__src2_i),32);
        bufp->chgIData(oldp+65,(vlSelf->cpu__DOT__datapath__DOT__datapath_data_memory__DOT__addr),32);
    }
    bufp->chgBit(oldp+66,(vlSelf->clk_i));
    bufp->chgBit(oldp+67,(vlSelf->rst_i));
    bufp->chgBit(oldp+68,(vlSelf->trigger_i));
    bufp->chgIData(oldp+69,(vlSelf->a0_o),32);
    bufp->chgBit(oldp+70,((((vlSelf->cpu__DOT__datapath__DOT__reg_rd1 
                             != vlSelf->cpu__DOT__datapath__DOT____Vcellinp__datapath_alu__src2_i) 
