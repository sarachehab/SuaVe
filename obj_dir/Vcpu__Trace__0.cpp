...
void Vcpu___024root__trace_chg_sub_0(Vcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+39,((((IData)(vlSelf->__VdfgTmp_hc6c9cc1a__0) 
        ...
        bufp->chgCData(oldp+46,((0x7fU & (IData)(vlSelf->__VdfgTmp_h0f734668__0))),7);
        bufp->chgCData(oldp+47,((7U & ((IData)(vlSelf->__VdfgTmp_h0cdf22a8__0) 
                                       >> 4U))),3);
        bufp->chgBit(oldp+48,((1U & ((IData)(vlSelf->__VdfgTmp_hc6c9cc1a__0) 
                                     >> 6U))));
        ...
        bufp->chgBit(oldp+52,((1U & ((IData)(vlSelf->__VdfgTmp_h0f734668__0) 
                                     >> 5U))));
        bufp->chgBit(oldp+53,((1U & (((IData)(vlSelf->__VdfgTmp_hc6c9cc1a__0) 
                                      >> 6U) & ((IData)(vlSelf->__VdfgTmp_h0f734668__0) 
                                                >> 5U)))));
        bufp->chgCData(oldp+54,((0x1fU & (vlSelf->__VdfgTmp_h2e56604c__0 
                                          >> 0xfU))),5);
        bufp->chgCData(oldp+55,(((0x10U & ((IData)(vlSelf->__VdfgTmp_hc6c9cc1a__0) 
                                           << 4U)) 
                                 | (0xfU & (vlSelf->__VdfgTmp_h2e56604c__0 
                                            >> 0x14U)))),5);
        bufp->chgCData(oldp+56,((0x1fU & ((IData)(vlSelf->__VdfgTmp_hee5fc8f3__0) 
                                          >> 7U))),5);
        bufp->chgIData(oldp+57,(vlSelf->cpu__DOT____Vcellinp__extend_unit__instr_i),25);
